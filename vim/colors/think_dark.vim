" Vim color file
" Maintainer:   Grant Hernandez
" Last Change:  December 17 2011
"
" think_dark.vim - a modified version of Wombat by Lars Nielsen that also
...
"
" Reference photo was the IBM ThinkPad logo
"
" Interesting Approximate Color Accents
"   #c80000 (darkish red, ~trackpoint color)
"   #eaf1d4 (chrome white)
"   #c6ccb3 (darker white)
"
"   -- IBM ThinkPad Logo Palette --
"   --  High Contrasting Colors  --
"
"   #fd0010 (red)   I
"   #00fd5d (green) B
"   #3366fe (blue)  M
"   #fefefe (white) ThinkPad
...
call <SID>X("Normal",		"c6ccb3",	"000000",	"none")
...
" Syntax highlighting ordered by importance
" See :help group-name for more information AND
" a demonstration of the current syntax highlighting

call <SID>X("Comment",		"00fd5d",	"",			"italic")

call <SID>X("Constant",		"b000ff",	"",			"none")
call <SID>X("String",		"00b2a5",	"",			"italic")
call <SID>X("Number",		"c6ccb3",	"",			"none")
call <SID>X("Character",	"b000ff",	"",			"none")
			"Boolean
			"Float

call <SID>X("Identifier",	"3366fe",	"",			"none")
"call <SID>X("Function",		"caeb82",	"",			"none")

call <SID>X("Statement",	"fd0010",	"",			"none")
			"Conditional
			"Repeat
			"Label
			"Operator
...
call <SID>X("PreProc",		"ff7f00",	"",			"bold")
			"Include
			"Define
			"Macro
			"PreCondit

call <SID>X("Type",			"3366fe",	"",			"none")

call <SID>X("Special",		"b000ff",	"",			"none")
